...
Clicca il pavimento o una parete nel 3D, oppure usa **Pavimento** e il menu **Pareti** sopra il catalogo. Il pannello **Materiale e colore** comprende **20 materiali**, filtrabili per categoria: legni e parquet, cementi e resina, intonaci e mattoni, marmi e terrazzo, piastrelle, tessuti e metalli. Le anteprime mostrano le texture effettivamente usate nel 3D. Tinta personalizzabile tramite selettore, codice HEX e palette del progetto; finitura opaca, satinata o lucida. Il bianco mantiene il colore originale della texture; **Ripristina colore originale** rimuove la tinta.
...
18 materiali utilizzano set PBR ambientCG con licenza CC0: colore 2048 × 2048, rilievo tramite normal map OpenGL e rugosità 1024 × 1024. Tinta unita e resina sono finiture uniformi. Le mappe sono incluse in `public/materials` e funzionano offline. Gli asset sono caricati quando servono, condivisi tra superfici uguali e conservati in una cache limitata per i set non più utilizzati. Filtraggio anisotropico fino a 16× secondo la GPU; ambiente di riflessione neutro per leggere le finiture metalliche.

**Modulo texture** indica la larghezza reale dell'intero campione, non quella di una singola piastrella o doga. La direzione è regolabile in gradi. La trama mantiene la scala dopo il ridimensionamento e prosegue attraverso le aperture. Le precedenti impostazioni del parquet vengono convertite una sola volta al nuovo modulo; tintura e orientamento restano conservati. Le finiture non sono campioni certificati di produttori né una riproduzione colorimetrica del materiale reale. Provenienza, licenza e procedura di preparazione in `assets/materials/CREDITS.md`.
